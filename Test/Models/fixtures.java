...
public class fixtures {
	  ...
	  {
	    new User ("marge", "simpson", 32,"F",   "housewife"),
	    new User ("lisa",  "simpson",  10,"F",   "student"),
	    new User ("bart",  "simpson", 12,"M",    "student"),
	    new User ("maggie","simpson", 2,"M", "none"),
	    new User ("homer","simpson", 35,"M","physicist"),
		}; 
